import { Jt as renderSlot, nt as defineComponent, pt as h } from "./vue.runtime.esm-bundler-C-HWsTP5.js";
//#region node_modules/.pnpm/@iconify+vue@5.0.0_vue@3.5.32_typescript@5.9.3_/node_modules/@iconify/vue/dist/offline.mjs
...
var Icon = defineComponent((props, ctx) => {
	return () => {
		...
		if (icon === null || typeof icon !== "object" || typeof icon.body !== "string") return renderSlot(ctx.slots, "default");
		return render({
			...defaultIconProps,
			...icon
		}, props);
