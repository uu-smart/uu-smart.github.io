...
import { App, LocaleConfig, LocaleData } from "vuepress";
 ...
 * CanIUse 显示模式
 */
type CanIUseMode = 'embed' | 'baseline' /** @deprecated */ | 'image';
/**
...
//#endregion
//#region src/shared/encrypt.d.ts
/**
 * Encrypt Snippet Locale
 *
 * 加密片段本地化
 */
interface EncryptSnippetLocale extends LocaleData {
  /**
   * Hint message
   *
   * 提示信息
 ...
 * 加密片段选项
 */
interface EncryptSnippetOptions {
  /**
   * Default password
   *
   * 默认密码
 ...
 */
interface MDPowerLocaleData extends LocaleData {
  /**
   * Common locale data
   *
   * 通用本地化数据
 ...
 * 通用本地化数据
 */
interface CommonLocaleData extends LocaleData {
  /**
   * Copy button text
   *
   * 复制按钮文本
...
//#endregion
export { AcFunTokenMeta, ArtPlayerTokenMeta, BilibiliTokenMeta, CanIUseMode, CanIUseOptions, CanIUseTokenMeta, CodeSandboxTokenMeta, CodeTabsOptions, CodepenTokenMeta, CommonLocaleData, DemoContainerRender, DemoFile, DemoMeta, FileTreeIconMode, FileTreeOptions, FontAwesomeAssetBuiltIn, FontAwesomePrefix, FontAwesomeProvider, IconAssetLink, IconFontProvider, IconOptions, IconProviderBase, IconifyPrefix, IconifyProvider, JSFiddleTokenMeta, LiteralUnion, MDPowerLocaleData, MarkdownDemoEnv, MarkdownEnvPreset, MarkdownPowerPluginOptions, NpmToOptions, NpmToPackageManager, PDFEmbedType, PDFOptions, PDFTokenMeta, PlotOptions, QRCodeMeta, QRCodeProps, ReplEditorData, ReplOptions, ReplitTokenMeta, SizeOptions, ThemeOptions, VideoOptions, YoutubeTokenMeta };